...
$categoryId = $oldData['category_id'] ?? 0;
$authorId = $oldData['author_id'] ?? 0;
$publisherId = $oldData['publisher_id'] ?? null;
$shelfId = $oldData['shelf_id'] ?? null;
$isbn10 = $oldData['isbn10'] ?? '';
$isbn13 = $oldData['isbn13'] ?? '';
$edition = $oldData['edition'] ?? '';
$language = $oldData['language'] ?? 'English';
$publishYear = $oldData['publish_year'] ?? '';
    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="bi bi-book me-2 text-primary"></i>Add Book</h5>
            </div>
            <div class="card-body p-4 p-md-5">
                <form action="<?= base_url('books/store') ?>" method="POST" enctype="multipart/form-data" novalidate>
                    <?= csrf_field() ?>
