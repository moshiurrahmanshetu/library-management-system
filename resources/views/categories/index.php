...
<?php if (($lastPage ?? 1) > 1): ?>
    <nav aria-label="Categories pagination" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php if (($page ?? 1) > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('categories?page=' . (($page ?? 1) - 1) . (($search ?? '') ? '&search=' . urlencode($search) : '')) ?>">Previous</a>
                </li>
            <?php endif; ?>
            ...
            <?php if (($page ?? 1) < ($lastPage ?? 1)): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('categories?page=' . (($page ?? 1) + 1) . (($search ?? '') ? '&search=' . urlencode($search) : '')) ?>">Next</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
