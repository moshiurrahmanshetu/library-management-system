    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="bi bi-columns-gap me-2 text-primary"></i>Add Shelf</h5>
            </div>
            <div class="card-body p-4 p-md-5">
                <form action="<?= base_url('shelves/store') ?>" method="POST" novalidate>
                    <?= csrf_field() ?>
