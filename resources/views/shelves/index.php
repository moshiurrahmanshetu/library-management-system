...
<?php if ($lastPage > 1): ?>
    <nav aria-label="Shelves pagination" class="mt-4">
        <ul class="pagination justify-content-center">
            <?php if ($page > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('shelves?page=' . ($page - 1) . ($search ? '&search=' . urlencode($search) : '')) ?>">Previous</a>
                </li>
            <?php endif; ?>
            ...
            <?php if ($page < $lastPage): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('shelves?page=' . ($page + 1) . ($search ? '&search=' . urlencode($search) : '')) ?>">Next</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
